...
if(os.path.exists("aplicacao/cubos-exercicios/imagens/CincoCubicos.png")):
    os.remove("aplicacao/cubos-exercicios/imagens/CincoCubicos.png")
plt.savefig("aplicacao/cubos-exercicios/imagens/CincoCubicos.png")
plt.show()
...
if(os.path.exists("aplicacao/cubos-exercicios/imagens/CincoMilCubicos.png")):
    os.remove("aplicacao/cubos-exercicios/imagens/CincoMilCubicos.png")
plt.savefig("aplicacao/cubos-exercicios/imagens/CincoMilCubicos.png")
plt.show()